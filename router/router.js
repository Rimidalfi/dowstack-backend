...
import { createGoalEntry,goalById,goalByUserId,updateGoalById,deleteGoalById} from "../controller/goalController.js";
...
savingGoalRouter.get('/user/:id',goalByUserId);
savingGoalRouter.get('/:id',goalById);
savingGoalRouter.post('/',createGoalEntry);
savingGoalRouter.put('/',updateGoalById);
savingGoalRouter.delete('/',deleteGoalById);
